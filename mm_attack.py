...
loss, autopgd_ce_acc, autopgd_ce_time  = attack.eval_robust_auto(model, test_loader, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn="ce",category="Madry",rand_init=True, num_classes = args.num_classes)
print('apgd ce acc:')
print(autopgd_ce_acc)
print('apgd ce time:')
print(autopgd_ce_time)

loss, autopgd_dlr_acc, autopgd_dlr_time  = attack.eval_robust_auto(model, test_loader, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn="dlr",category="Madry",rand_init=True, num_classes = args.num_classes)
print('apgd dlr acc:')
print(autopgd_dlr_acc)
print('apgd dlr time:')
print(autopgd_dlr_time)

loss, autopgd_fab_acc, autopgd_fab_time  = attack.eval_robust_auto_fab(model, test_loader, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn="fab",category="Madry",rand_init=True, num_classes = args.num_classes)
print('apgd fab acc:')
print(autopgd_fab_acc)
print('apgd fab time:')
print(autopgd_fab_time)

loss, autopgd_square_acc, autopgd_square_time  = attack.eval_robust_auto_square(model, test_loader, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn="square",category="Madry",rand_init=True, num_classes = args.num_classes)
print('apgd square acc:')
print(autopgd_square_acc)
print('apgd square time:')
print(autopgd_square_time)

loss, test_mm3_acc, mm3_time = attack.eval_robust_mm_sequential(model, test_loader_all, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn='mm',category="Madry",rand_init=True, k=3, num_classes=args.num_classes)
print('MM3 acc:')
print(test_mm3_acc)
print('MM3 time:')
print(mm3_time)

loss, test_mm9_acc, mm9_time = attack.eval_robust_mm_sequential(model, test_loader_all, perturb_steps=20, epsilon=0.031, step_size=0.003 ,loss_fn='mm',category="Madry",rand_init=True, k=9, num_classes=args.num_classes)
print('MM9 acc:')
print(test_mm9_acc)
print('MM9 time:')
print(mm9_time)

loss, test_mm_plus_acc, mm_plus_time = attack.eval_robust_mm_sequential(model, test_loader_all, perturb_steps=100, epsilon=0.031, step_size=0.003 ,loss_fn='mm',category="Madry",rand_init=True, k=9, num_classes=args.num_classes)
print('MM_plus acc:')
